...
export const PUZZLES = {
  ...
  "2026-03-27": {
    weekBadge: "WEEK 2: BASEBALLS BACK!",
    gridLabel: "GRID #6: STEP UP TO THE PLATE BALLERS",
    cornerPhrase: "Opening Day is here, Do you know your ballers?",
    columns: [
      { name: "AL East",    nickname: "", color: "#002D62", border: "#1a5fa8" },
      { name: "AL Central", nickname: "", color: "#C0111F", border: "#e04040" },
      { name: "NL East",    nickname: "", color: "#005A9C", border: "#1a80d0" },
    ...
    answerPool: {
      "0-0": ["Pete Alonso","Taylor Ward","Willson Contreras","Caleb Durbin","Kazuma Okamoto","Samuel Basallo"],
      "0-1": ["Kevin McGonigle"],
      "0-2": ["Bo Bichette","Marcus Semien","Carson Benge"],
      "0-3": ["Kyle Tucker","Nolan Arenado","TJ Rumfield"],
      "1-0": ["Gunnar Henderson","Adley Rutschman","Pete Alonso","Roman Anthony","Trevor Story","Jarren Duran","Trent Grisham","Aaron Judge","Cody Bellinger","Yandy Díaz","Jonathan Aranda","Junior Caminero","George Springer","Daulton Varsho","Vladimir Guerrero Jr."],
      ...
      "1-2": ["Ronald Acuña Jr.","Drake Baldwin","Matt Olson","Jakob Marsee","Otto Lopez","Christopher Morel","Francisco Lindor","Juan Soto","Bo Bichette","Trea Turner","Kyle Schwarber","Bryce Harper","CJ Abrams","Jacob Young","James Wood"],
      "1-3": ["Geraldo Perdomo","Ketel Marte","Corbin Carroll","Jake McCarthy","Willi Castro","Hunter Goodman","Shohei Ohtani","Kyle Tucker","Mookie Betts","Xander Bogaerts","Jackson Merrill","Manny Machado","Luis Arraez","Matt Chapman","Rafael Devers"],
      "2-0": ["Aaron Judge"],
      "2-1": ["José Ramírez"],
      "2-2": ["Juan Soto"],
      "2-3": ["Kyle Tucker"],
      "3-0": ["Aaron Judge"],
      "3-1": ["Salvador Perez","José Ramírez","Byron Buxton","Christian Yelich"],
      "3-2": ["Bryce Harper"],
      "3-3": ["Miguel Rojas"],
    },
  },
