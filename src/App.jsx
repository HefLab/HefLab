...
export default function App() {
  ...
  return (
    <div style={bgStyle}>
      ...
      <div style={{ textAlign: "center", padding: "2px 10px 6px", fontSize: 9, color: "rgba(255,215,0,0.72)", letterSpacing: 0, fontFamily: "'Arial', sans-serif", fontStyle: "italic", whiteSpace: "nowrap" }}>
